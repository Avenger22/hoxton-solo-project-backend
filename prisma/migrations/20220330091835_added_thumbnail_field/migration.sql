...
INSERT INTO "new_Video" ("categoryId", "countCommentsInside", "countDislikesInside", "countLikesInside", "createdAt", "description", "id", "src", "title", "updatedAt", "userId") SELECT "categoryId", "countCommentsInside", "countDislikesInside", "countLikesInside", "createdAt", "description", "id", "src", "title", "updatedAt", "userId" FROM "Video";
DROP TABLE "Video";
