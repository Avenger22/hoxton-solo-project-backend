...
INSERT INTO "new_Video" ("categoryId", "countCommentsInside", "countDislikesInside", "countLikesInside", "createdAt", "description", "id", "savedInPlaylist", "src", "thumbnail", "title", "updatedAt", "userId", "views") SELECT "categoryId", "countCommentsInside", "countDislikesInside", "countLikesInside", "createdAt", "description", "id", "savedInPlaylist", "src", "thumbnail", "title", "updatedAt", "userId", "views" FROM "Video";
DROP TABLE "Video";
